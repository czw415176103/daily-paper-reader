...
title_zh: 从机械可解释性到组合可解释性
authors: "Ward Gauderis, Thomas Dooms, Steven T. Holmer, Kola Ayonrinde, Geraint A. Wiggins"
date: 2026-05-09
pdf: "https://arxiv.org/pdf/2605.08934v1"
tags: ["query:q4"]
score: 8.0
evidence: 机械可解释性的正式框架
tldr: 本研究针对神经网络机制可解释性缺乏形式化框架的问题，提出组合可解释性这一范畴论框架，基于组合性和最小描述长度原则。该框架将解释质量解构为忠实度和复杂度，将可解释性转化为约束优化问题，并引入压缩精化来系统重构模型。研究证明简约性准则下语法压缩能保证更简洁、符合人类认知的解释，为自动化发现和评估机制解释提供了可测量、可优化的理论基础。
source: arxiv
...
motivation: 现有机制可解释性缺乏形式化框架，无法客观验证、比较或组合解释。
method: 引入组合可解释性框架，将解释质量解构为忠实度和复杂度，并通过压缩精化系统重构模型。
result: 证明简约性准则下，语法压缩理论上能保证更简洁、符合人类认知的解释。
conclusion: 该研究为自动化发现和评估机制解释提供了可测量、可优化的理论基础。
---

## 摘要
机械可解释性旨在通过将学习到的计算结构逆向工程为人类可理解的组件来解释神经模型行为。然而，缺乏形式化框架时，机械解释无法被客观验证、比较或组合。我们引入组合可解释性，这是一个基于组合性与最小描述长度原则的范畴论框架。组合解释由语法与语义映射对组成，必须满足交换性以确保模型分解与其观测行为之间的一致性。我们将解释质量解构为忠实度与复杂度度量，从而将可解释性视为约束优化问题，并引入压缩精炼以在不改变模型功能的前提下系统性地将其重构为更简单的部分。最后，我们证明了一个简约性准则，在该准则下语法压缩理论上能保证更简洁、更符合人类认知的解释。我们的框架将主流机械方法定位为精炼的子类，并阐明了为何它们的可压缩性启发式方法往往与人类可解释性一致。我们的工作为自动化发现与评估机械解释提供了可测量、可优化的基础。
